# -*- coding: utf-8 -*-
"""
Created on Tue Dec 26 16:10:55 2023
@author: Jerry Li
Description: 使用简化版的欧几里得代码，制作多个obj文件的绘制。
ChangedParts:
...
# tau蛋白扩散的相关系数文件夹路径：
TauCoefficients_FolderName ='Tau_coefficients_all/' # 'Tau_coefficients14/' #
# 欧几里得项系数改变：
...
def iteration_num(n, obj_content, iteration):
    ...
    print(obj_content['iAOB']['region_concentrations'])
