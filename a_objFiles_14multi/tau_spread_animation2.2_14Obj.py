# -*- coding: utf-8 -*-
"""
Created on Thu Dec 18 09:53:54 2023
...
#injected_obj_files = ['iAOB.obj', 'iMOB.obj']
#injected_obj_files = ['iAOB.obj', 'iMOB.obj', 'iMOs.obj']
# 示例使用的参数
...
def read_obj_file(file_path):
    ...
    if file_path in injected_obj_files:
        ...
        region_concentrations[:NUM_INJECTED] = Initial_Concentration  # 前NUM_INJECTED个元素设为初始的浓度值。
